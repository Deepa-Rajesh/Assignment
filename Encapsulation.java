...
public class Encapsulation {
    ...
    class CollegeDepartmentList{
        ...
        Encapsulation myObj[] = new Encapsulation[5];
        // Set the value of College name and Department name
        myObj[0] = new Encapsulation();
